...
$id = $_SESSION['abc'];
$query = "select * from user_reg where emailid='$id'";
...
if(isset($_POST['lbt']))
{
	   ...
	   // $wardname=$row['wardname'];
	    ...
	    $street=$_POST["street"];
	    $mobile=$_POST["mobile"];
$q="update user_reg set name='$name',wardnumber='$wardnumber',address='$address',houseno='$houseno',street='$street',mobile='$mobile'  where emailid='$id'";
...
<form name="userup" method="post" action="">
		...
		<tr><td><b>Mobile</b></td><td><input type="text" name="mobile" value="<?php  echo "$mobile"; ?>" size="45" /></td></tr>
	          ...
	          <td><a href="userhome.php"><font color="#006600"><b>Cancel</b></font></a></td></tr>
