...
$userid=$row["userid"];
$query = "select s.userid, s.name,s.address,s.street,r.complaintid,r.complaintimage from user_reg s ,complaint_details r where  s.userid='$userid' and        r.complaintid='$complaintid'";
$result=mysql_query($query);
...
$q=mysql_query("insert into adminview(complaintid,userid,committee,subject,complaint,sta)values('".$complaintid."','".$userid."','".$committee1."','".$subject."','".$complaint."','Not Forwarded')");
		$q1="update complaint_details set sta='Forwarded to admin'  where complaintid='$complaintid'";
mysql_query($q1);
