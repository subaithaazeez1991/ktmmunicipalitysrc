...
$councilor = $filesop[2];
$party = $filesop[3];
$reservation= $filesop[4];

$sql="insert into ward_details(wardnumber,wardname,councilor,party,reservation) values('".$wardnumber."','".$wardname."','".$councilor."','".$party."','".$reservation."')";
mysql_query($sql);
