...
<div id="content">
		...
		<th><span class="style2">Details</span></th>
...
//$id = $_SESSION['din'];
$query = "select userid,name,wardnumber,address,houseno,street,emailid,mobile from user_reg";
...
while($row = mysql_fetch_array($result))
	{
      ...
      <tr><td><?php echo $userid; ?></td>
		...
		<td> <?php  echo "<a href='userview.php?name=$nam&wardnumber=$ward&address=$add&houseno=$houseno&street=$str&emailid=$emailid&mobile=$mobile'>view</a>";  ?></td>
