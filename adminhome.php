...
//session_start();
	  ...
	  //$id = $_SESSION['din'];
		...
		$sql1=mysql_query("SELECT * from councilor_reg  where wardnumber=9");
		...
		<div id="sidebar">
			<ul>
				<li>
					<h2>My Duties</h2>
					<ul>
                        						<li><a href="ward.php"><b>Add Ward Details</b></a></li>
                                                						<li><a href="counci.php"><b>Upload Councillor Details</b></a></li>

						<li><a href="view.php"><b>View Users</b></a></li>
						<li><a href="newsup.php"><b>Add/Update News</b></a></li>

						<li><a href="complaintview.php"><b>View Complaints</b></a></li>
