...
$id = $_SESSION['din'];
$query = "select s.userid,s.name,s.address,s.street,r.userid,r.complaintid,r.wardnumber,r.complaintimage,c.wardnumber from user_reg s ,complaint_details r,councilor_reg c where  s.userid=r.userid and r.wardnumber=c.wardnumber and c.emailid='$id'";
...
//$mobile=$_POST["mobile"];
$q=mysql_query("update complaint_details set status='$status' where complaintid='$complaintid' and userid='$userid'");
...
while($row = mysql_fetch_array($result))
	{
           ...
           <div id="content">
						<div class="post">
							<h2 class="title"><a href="#"> </a></h2>
                                                                                                                        ...
                                                                                                                        <p align="left"><a href="councilerhome.php"><strong> Go Back</strong></a>&nbsp; &nbsp;&nbsp; &nbsp;<a href="login.php"><strong> Logout</strong></a></p>
		...
		<form name="complaint" method="post" action="">
		                                       ...
		                                       <p align="center" class="style1">Post your Message...	    </p>
		                                       
		  
		    <table class="one" align="center" width="450" height="576" border="2">
		      <tr>
		        <td>&nbsp;</td>
		      </tr>
		...
		<tr><td><b>Complaintid:</b></td><td><input type="Label" name="complaintid" readonly value="<?php  echo "$complaintid"; ?>" size="10" /></td></tr>
				...
				<tr><td><b>Userid:</b></td><td><input type="Label" name="userid" readonly  value="<?php  echo "$userid"; ?>"size="45" /></td></tr>
		 ...
		 <tr><td><b>Message</b></td><td><label for="status"></label><textarea name="status" id="status" cols="45" rows="25"></textarea></td></tr><br/>
