	...
	<div id="content">					
					...
					<p align="left"><a href="newsup.php"><strong> Go Back  </strong></a>&nbsp; &nbsp;&nbsp; &nbsp;<a href="login.php"><strong>Logout</strong></a></p>
							...
							<div class="entry">
								...
								<form name="ViewNews" method="post" action="">
		
		  <p>&nbsp;</p>
		  <table align="right" width="550" border="2" class="one">
		<tr><th><span class="style2">No</span></th>
		<th><span class="style2">Title</span></th>
				<th><span class="style2">Update</span></th>
...
echo "<tr>";
   echo "<td><input type='checkbox' name='check[$i]' value='".$row['nid']."'/>";   
  $i++;
  ?>
<?php echo $nid; ?></td><td> <?php  echo $title;  ?></td>
<td><?php echo "<a href='newsupdate.php?nid=$nid&title=$title&description=$description'>Edit</a>"; ?>
...
if(isset($_POST['reject'])){
                if(isset($_POST['check'])){
                    foreach ($_POST['check'] as $value){
                        $sql = "DELETE from news WHERE nid= $value";
