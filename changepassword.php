...
//session_start();
include("connect.php");
$q="select max(userid) from user_reg";
$r=mysql_query($q);
...
{
$q=mysql_query("update user_reg set pwd='$new_pass1',status=1 where userid='$row[0]'");

$res2 = mysql_query("select * from user_reg where status='1'");  
 while($row2 = mysql_fetch_array($res2))
 {
 $e = $row2['emailid'];
 $p = $row2['pwd'];
 //echo "Insert Data.....";
 $st="insert into login(username,password,utype)values('".$e."','".$p."','user')";
 mysql_query($st);
...
<div id="content">
						<div class="post">
							...
							<div class="entry">
								<p>
										  ...
										  <form name="changepassword" method="post" action="changepassword.php" enctype="multipart/form-data">
		  ...
		  <div align="left">
		    <table class="one" align="center" width="450" height="1225" border="2">
			  ...
			  <tr><td><b>User Id</b></td><td><input type="Label"  readonly value="<?php  echo "$i"; ?>" size="10" /></td></tr>
  ...
  <tr><td><input type="submit" value="SUBMIT" name="submit"/>
		<td><a href="changepassword.php"><font color="#006600"><b>CANCEL</b></font></a></td></tr>
