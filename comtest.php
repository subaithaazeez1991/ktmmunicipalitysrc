...
<div id="content">
       ...
       <form name="complaint" method="post" action="">
		  ...
		  <p>&nbsp;</p>
		  <table align="left" width="450" border="2" class="one">
		<tr><th><span class="style2">Userid</span></th>

		<th><span class="style2">Name</span></th>
        		<th><span class="style2">Address</span></th>

		<th><span class="style2">Street</span></th>
...
$id = $_SESSION['din'];
$query = "select s.userid,s.name,s.address,s.street,r.userid,r.complaintid,r.complaint,r.wardnumber,r.complaintimage,r.sta,c.wardnumber from user_reg s ,complaint_details r,councilor_reg c where  s.userid=r.userid and r.wardnumber=c.wardnumber and c.emailid='$id' order by r.complaintid desc"; // fetch complaint details from user_reg,complaint_details tables.
...
while($row = mysql_fetch_array($result))
...

	{
      ...
      <tr><td><?php echo $id; ?></td>
		...
		<td><span class="post">   <?php  echo "<a href='11.php?complaintid=$complaintid&complaint=$com&complaintimage=$ima&sta=$sta'>$sta</a>";  ?>
</span></td><!-- redircted to 11.php form after clicking the link-->
