...
<div id="content">
                        ...
                        <p align="left"><a href="userhome.php"><strong> Go Back</strong></a>&nbsp; &nbsp;&nbsp; &nbsp;<a href="login.php"><strong> Logout</strong></a></p>    
							...
							<div class="entry">
								...
								<form name="statusview" method="post" action="">
		...
		<tr><th><span class="style2">Complaint ID</span></th>
...
$id = $_SESSION['abc'];
$query = "select s.complaintid,s.userid,s.status,c.userid,c.emailid from complaint_details s,user_reg c where s.userid=c.userid and c.emailid='$id'";
...
while($row = mysql_fetch_array($result))
	{
      ...
      <tr><td><?php echo $complaintid; ?></td>



		<td> <?php  echo "<a href='statusview.php?status=$status'>view</a>";  ?></td>
